...
ServoXforward = map(val1X, 0, 1023, 180, 0); // Used to move Servo 0
ServoXbackward = map(val1X, 0, 1023, 0, 180); // Used to move Servo 12 inverted

ServoYforward = map(val1Y, 0, 1023, 0, 180); // Used to move Servo 4
ServoYbackward = map(val1Y, 0, 1023, 180, 0); // Used to move Servo 8 inverted
